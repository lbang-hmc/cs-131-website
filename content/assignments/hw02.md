...
!!! note "How you'll get materials and submit this assignment"
    Getting the starter code and turning in your work follows the same process as every homework this semester — see [**The Homework Workflow**](../how-to/homework-workflow.md) for the full walkthrough. In short: make your own private copy of the `hw2` template repo, clone it to the course server, and submit your test log (and reflection) on Gradescope. The rest of this page covers what the assignment actually asks of you.
...
You'll get the starter files by making your own private copy of the `hw2` template repository and cloning it to the course server — [The Homework Workflow](../how-to/homework-workflow.md) walks through every step.
...
Submit on [Gradescope](https://www.gradescope.com), under **HW 02: FUNctional Programming**. Run the full test suite one last time, capture its output to a log file, and paste that log into the submission — the [Writing and Running Tests](../how-to/writing-and-running-tests.md) guide has the commands, and [The Homework Workflow](../how-to/homework-workflow.md) covers the submission step in context. There's also a short **HW 2 reflection** to submit separately on Gradescope.
