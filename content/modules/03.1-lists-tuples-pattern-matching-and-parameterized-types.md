...
- **higher-order functions** such as `filter` let us describe common list-processing patterns without writing the traversal ourselves.
...
- `x`, the first element, which we will use as a **pivot**, and
